    ...
    <?php foreach ($db as $domanda => $array_risposte) { ?>
      ...
      <?php foreach ($array_risposte as $risposta) { ?>
        <?php //foreach ($risposta as $paragrafo) { ?>
          <p><?php echo $risposta[0];//$paragrafo ?></p>
        <?php //} ?>
      <?php } ?>
    <?php } ?>
  </body>
